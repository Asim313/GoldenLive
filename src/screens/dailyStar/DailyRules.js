        ...
        <ImageBackground
          ...
          <Text style={{fontWeight: '500'}}>
            ...
            <TouchableOpacity
              ...
              <EventRulePagw marginLeftt={60} Sentence = {'Detailed Rules'}/>
           </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            <EventRulePagw marginLeftt={60} Sentence={'Host Reward'} />
        </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            <EventRulePagw Sentence = {'User Reward'} marginLeftt={60} />
         </TouchableOpacity>
          <View style={{alignItems: 'center', alignItems: 'center'}}>
            <View
              style={{
