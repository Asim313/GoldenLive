...
export default function UserProfile() {
  console.log('llllllllllll', userUpdatedData);
          ...
          <TouchableOpacity>
            <View style={styles.inputmainbox}>
              <View>
                ...
                <View style={styles.Usernamebox}>
                  <Text style={styles.Usernametxt}>{userInfo?.birthday}</Text>
                </View>
              </View>
            </View>
          </TouchableOpacity>
